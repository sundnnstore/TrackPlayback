...
using TrackPlayback.Properties;
...
namespace TrackPlayback
{
    public partial class frmPlayback : Form
    {
        ...
        private void InitDgv()
        {
            ...
            colStation = CSubClass.CreateColumn("StationName", "站点", 1, 100);
        ...
        private void InitMap()
        {
            ...
            Bitmap bitmap = Properties.Resources.Bus;
        ...
        private void GetLinesInfo()
        {
            ...
            try
            {
                ...
                {
                    coll.Add(new ExComboBox(i, CLineList.LineInfo[i].LineID2.ToString(), CLineList.LineInfo[i].Name.ToString()));
                }
            }
            finally
            {
        ...
        private void ShowBusPoint(int indexSelected)
        {
            ...
            //图标
            if (RowList[indexSelected].StatusExtra == 2)
            {
                busMarker.Image = Properties.Resources.Bus3;
            }
            else
            {
                if (RowList[indexSelected].DirectNum == 0)
                {
                    busMarker.Image = Properties.Resources.Bus1;
                }
                else if (RowList[indexSelected].DirectNum == 1)
                {
                    busMarker.Image = Properties.Resources.Bus2;
                }
                else
                {
                    busMarker.Image = Properties.Resources.Bus;
                }
            }
            ...
            if (!pnlDgv.Visible)
            {
                ...
                else
                {
                    ttInfo.Show("时间：　" + RowList[indexSelected].ITime.ToString("HH:mm:ss") + Environment.NewLine 
                            ...
                            + "站点：　" + RowList[indexSelected].StationName, gmap, (int)point.X + 10, (int)point.Y + 10);
                }
            }
            else
            {
        ...
        private void frmPlayback_SizeChanged(object sender, EventArgs e)
        {
            ...
            if (this.ClientSize.Height > 660)
            {
                panelMain.Height = this.ClientSize.Height;
            }
            else
            {
                panelMain.Height = 660;
            }
        }
